...
<body>
    <div class="container">
        <div class="row mt-3">
            <div class="col-md-3">
                <a href="index.php"><h3 class="mt-2">Admin Page</h3></a>
            </div>
            <div class="col-md-9">
                <div class="float-end mt-3"><a href="?log=logout">Logout</a></div>
                <div class="float-end mt-3 me-4">User : <a href="?f=user&m=updateuser&id=<?php echo $_SESSION['iduser'] ?>"><?php echo $_SESSION['user'] ?></a></div>
